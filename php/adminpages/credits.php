				...
				<div class="postbox" id="rest-xmlrpc-data-checker-credits">
					...
					<div class="inside">
						...
						<p><?php esc_html_e( 'What\'s new in', 'rest-xmlrpc-data-checker' ); ?>
							<a href="https://github.com/enrico-sorcinelli/rest-xmlrpc-data-checker/releases" target="_blank"><?php /* translators: */ echo esc_html( sprintf( __( 'version %s', 'rest-xmlrpc-data-checker' ), REST_XMLRPC_DATA_CHECKER_VERSION ) ); ?></a>.</p>
						<h4><?php esc_html_e( 'Support', 'rest-xmlrpc-data-checker' ); ?></h4>
						<p><span class="dashicons dashicons-email-alt"></span>
							<a href="https://github.com/enrico-sorcinelli/rest-xmlrpc-data-checker/issues" target="_blank"><?php esc_html_e( 'Feel free to ask for help', 'rest-xmlrpc-data-checker' ); ?></a>.</p>
						<div class="author">
